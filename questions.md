...
### 23. Какие есть особенности синтаксиса получения и записи значений в map?
...
### 24. Как происходит поиск по ключу в map?
...
### 25. Почему порядок обхода map всегда случайный?
...
### 26. Можно ли брать ссылку на значение, хранящееся по ключу в map?
