...
Map в Go - это указатель на структуру, содержащую в себе 9 полей:
- count     ***int*** : размер мапы, доступен при помощи функции ***len***
- 
...
Нельзя. Из-за эвакуации может получиться, что значения, хранящиеся в определённой ячейке памяти в текущий момент времени, в следующий момент времени уже могут там не храниться.
