...
### 35. Что такое receiver в Go?
***Receiver*** в Go - это аналог ***this*** в С++ - экземпляр определенного типа.

### 36. Что такое выравнивание памяти?
### 35. Можно ли в функции ввести дополнительный блок скобок {...}?
Да, можно. Это связано с тем, что очень большую функцию очень сложно декомпозировать.
